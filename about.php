  ...
  <section class="probootstrap-section">
    <div class="container">
      <div class="row mb30">
        <div class="col-md-12">
          <figure>
          <img src="admin/upload/<?php echo $image;?>" alt="Free HTML5 Bootstrap Template by uicookies.com" class="img-responsive">
          </figure>
        </div>
      </div>
      <div class="row">
...
<?php 
   ...
   if($slider_run)
   {
      $slider_row = mysqli_fetch_assoc($slider_run);
?>
  <section class="probootstrap-half">
    <div class="image" style="background-image: url(admin/upload/<?php echo $slider_row['image'];?>);"></div>
    <div class="text">
