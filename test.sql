...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2022 at 12:16 AM
...
('1234 5678 435678', 'John Doe', '12/25', 123, '9855');
...
ALTER TABLE `room_reserved`
  ...
  ADD CONSTRAINT `room_reserved_ibfk_2` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`);
